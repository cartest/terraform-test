...
module "vpc_test-2" {
  ...
  peer_matrix         = ["096334345123,vpc-beab15da,10.0.0.0/16"] # would like to have vars here
}
...
module "env_test-1" {
  ...
  bootstrap_public_route_table_id = "rtb-d6116eb2"  # didn't work with variable passwed from boostrap module
